...
values (2048601264366944256, '测试', 0, null, null, null, 1, 0, null, now(), null, 0);
...
values (2048601269345583104, '测试', 1, true, null, now(), null, 0);

insert into sys_role_menu (id, role_id, menu_id, tenant_id)
values
(2048601269412691968, 2048601269345583104, 2049629108245233664, 0),
(2048601269479800832, 2048601269345583104, 2049629108245233665, 0),
(2048601269546909696, 2048601269345583104, 2049629108245233666, 0),
(2048601269609824256, 2048601269345583104, 2049629108253622282, 0);
...
values
(2048601269672738816, gen_random_uuid(), 'admin', '用户88888', '$2b$12$8y2eNucX19VjmZ3tYhBLcOsBwy9w1IjBQE4SSqwMDL5bGQVp2wqS.', decode('24326224313224387932654E7563583139566A6D5A33745968424C634F', 'hex'), 'admin@example.com', 1, true, true, true, null, null, now(), now(), now(), 2048601264366944256, now(), null, 0),
(2049946297615646720, gen_random_uuid(), 'test', '用户66666', '$2b$12$BMiXsNQAgTx7aNc7kVgnwedXGyUxPEHRnJMFbiikbqHgVoT3y14Za', decode('24326224313224424D6958734E514167547837614E63376B56676E7765', 'hex'), 'test@example.com', 1, false, false, false, null, null, now(), now(), now(), 2048601264366944256, now(), null, 0);

insert into sys_user_role (id, user_id, role_id, tenant_id)
values
(2048601269739847680, 2048601269672738816, 2048601269345583104, 0),
(2049946493732913152, 2049946297615646720, 2048601269345583104, 0);
...
values
(2048601270062809088, 2048601269345583104, 2048601269806956544, 0),
(2048601270125723648, 2048601269345583104, 2048601269869871104, 0);
